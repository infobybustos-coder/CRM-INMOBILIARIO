...
import { CalendarDays, User, Eye, CheckCheck, CalendarClock, X } from "lucide-react";
import { marcarRealizada, cancelarEvento, reprogramarEvento } from "@/app/asesor/agenda/actions";
import { ETIQUETA_TIPO_EVENTO, EMOJI_TIPO_EVENTO } from "@/app/asesor/agenda/constantes";
