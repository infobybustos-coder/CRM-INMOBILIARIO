...
import { CalendarClock, User, Eye, CheckCheck, CalendarDays } from "lucide-react";
import { completarTarea, reprogramarTarea, eliminarTarea } from "@/app/asesor/tareas/actions";
import {
  ETIQUETA_PRIORIDAD,
  COLOR_PRIORIDAD,
  ...
  COLOR_ENTIDAD,
  BORDE_ENTIDAD,
} from "@/app/asesor/tareas/constantes";
